...
def train_graph_tokenizer(random_walks_file_path: str, dataset_name: str, walk_len: int,tokenizer_path:str, sample_num: int=None):
    '''
    ...
    for sample in tqdm(dataset):
        ...
        if len(text_data) == 100000:
            ...
            with open(f'../data/{dataset_name}/graph_paths/chunk_{file_count}.txt', 'w', encoding='utf-8') as fp:
                fp.write('\n'.join(text_data))
            text_data = []
            file_count += 1
    with open(f'../data/{dataset_name}/graph_paths/chunk_{file_count}.txt', 'w', encoding='utf-8') as fp:
    ...
    tokenizer.save(f'../data/{dataset_name}/models/{tokenizer_path}')
...
if __name__ == '__main__':
    ...
    graph_tokenizer = PreTrainedTokenizerFast(
        tokenizer_file=f'datasets/{dataset_name}/models/graph_tokenize.tokenizer.json', max_len=walk_len)
