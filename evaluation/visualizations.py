...
def plot_trend_over_time(embs: np.array, google_trends_df: pd.DataFrame, t_prob: list, anomalies: list):
    ...
    google_trends_df['Day'] = pd.to_datetime(google_trends_df['Day'])
    ...
    scat_anoms = hv.Scatter(data=google_trends_df[google_trends_df['Day'].isin(anomalies)], kdims='graphert_delta',
...
if __name__ == '__main__':
    ...
    dataset_name = 'enron'
    model_path = f'../data/{dataset_name}/models/poc_tf_ep15_walk32_model'
